...
public class AddDishActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_dish_form);
    ...
    public void onResume(){
        ...
        if(dishImage != null) {
            ...
            ((ImageView) findViewById(R.id.dishPicture)).setImageResource(R.drawable.ic_default_profile_picture_background);
        }
    }
